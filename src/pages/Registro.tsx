import "../assets/css/stylesheet-inicio-registro.css";
    ...
    <div className="profileregistro">
      ...
      <div className="register-container">
        <form id="registerForm">
          ...
          <input type="text" id="nombre" placeholder="Jhon Doe" name="nombre" required />
          <small id="error-nombre" className="text-danger"></small>

          {/* Email */}
          <label htmlFor="email"><b>Email (*)</b></label>
          <input type="email" id="email" placeholder="JhonDoe@dominio.cl" name="email" required />
          <small id="error-email" className="text-danger"></small>

          {/* Repetir Email */}
          <label htmlFor="repeat-email"><b>Repite Email (*)</b></label>
          <input type="email" id="repeat-email" placeholder="JhonDoe@dominio.cl" name="repeat-email" required />
          <small id="error-repeat-email" className="text-danger"></small>

          {/* Teléfono */}
          <label htmlFor="telefono"><b>Teléfono</b></label>
          <input type="tel" id="telefono" placeholder="+569-1234-5678" name="telefono" />
          ...
          <div className="clearfix mt-1 buttons-inline">
            <button type="button" className="cancelbtn">Cancelar</button>
            <button type="submit" className="signupbtn">Ingresar</button>
          </div>
        </form>
      </div>
    </div>
