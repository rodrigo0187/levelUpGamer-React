...
import "../css/stylesheet-nav-bar-custom.css";
import "../css/stylesheet-index.css";
      ...
      <div id="demo" className="carousel slide" data-bs-ride="carousel">
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item active">
            <img src="/img/CarouselSlide9.jpg" className="d-block w-100" />
          ...
          <div className="carousel-item">
            <img src="/img/CarouselSlide1.jpg" className="d-block w-100" />
            <div className="carousel-caption">
          ...
          {/* Item 3 */}
          <div className="carousel-item">
            <img src="/img/CarouselSlide10.jpg" className="d-block w-100" />
            <div className="carousel-caption">
          ...
          {/* Item 4 */}
          <div className="carousel-item">
            <img src="/img/CarouselSlide7.jpg" className="d-block w-100" />
            <div className="carousel-caption">
          ...
          {/* Item 5 */}
          <div className="carousel-item">
            <img src="/img/CarouselSlide8.jpg" className="d-block w-100" />
            <div className="carousel-caption">
          ...
          {/* Item 6 */}
          <div className="carousel-item">
            <img src="/img/CarouselSlide5.jpg" className="d-block w-100" />
            <div className="carousel-caption">
          ...
          <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            ...
            <div className="col-md-6 col-lg-4">
              <div className="category-card">
                <img src="/img/categorias-productos/JuegosDeMesa.webp" className="category-image" />
